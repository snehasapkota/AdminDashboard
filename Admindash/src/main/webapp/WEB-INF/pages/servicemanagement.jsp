                        ...
                        <c:when test="${not empty serviceList && serviceList.size() > 0}">
                            <c:forEach var="service" items="${serviceList}">
                                <tr>
                                    ...
                                    <td>
                                        <a href="${pageContext.request.contextPath}/EventManagement?section=service&action=edit&id=${service.id}" class="action-btn edit-btn">
                                            ✏️ Edit
                                        </a>
                                        <a href="${pageContext.request.contextPath}/EventManagement?section=service&action=delete&id=${service.id}" 
